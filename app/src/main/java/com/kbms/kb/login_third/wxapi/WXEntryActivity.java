package com.kbms.kb.login_third.wxapi;
...
import com.kbms.kb.login_third.Applicationtest;
import com.kbms.kb.login_third.Constants;
import com.kbms.kb.login_third.MainTestActivity;
...
public class WXEntryActivity extends Activity implements IWXAPIEventHandler {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Applicationtest.api.handleIntent(getIntent(), this);
    }
    ...
    protected void onNewIntent(Intent intent) {
        ...
        setIntent(intent);
        Applicationtest.api.handleIntent(intent, this);
    }
        ...
        try {
            ...
            BmobUser.loginWithAuthData(WXEntryActivity.this, authInfo,new OtherLoginListener() {
                ...
                public void onSuccess(JSONObject userAuth) {
                    ...
                    Intent intent = new Intent(WXEntryActivity.this,MainTestActivity.class);
