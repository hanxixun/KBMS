...
import com.kbms.kb.login_third.net.NetUtils;
...
public class MainTestActivity extends Activity implements View.OnClickListener {
    ...
    public void onClick(View arg0) {
        ...
        if (arg0 == btn_relation_weibo) {
            associateThirdParty(BmobUser.BmobThirdUserAuth.SNS_TYPE_WEIBO, "2.00htoVwCV9DWcB02e14b7fa50vUwjg", "1410548398554", "2696876973");
        } else if (arg0 == btn_relation_qq) {
            associateThirdParty(BmobUser.BmobThirdUserAuth.SNS_TYPE_QQ, "A5DAEFCA1946AFE9FE35CD16B76F0FD1", "7776000", "2F848CC297DCD3C0494E99DC71CECB16");
            ...
            associateThirdParty(BmobUser.BmobThirdUserAuth.SNS_TYPE_WEIXIN, accessToken, expiresIn, openId);
