...
import com.kbms.kb.connect_net.NotesSync;
import com.kbms.kb.notes.db.NotesDB;
...
public class NotesActivity extends Activity {
    ...
    private View.OnClickListener btnAddNote_clickHandler = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            startActivityForResult(new Intent(NotesActivity.this, AtyEditNote.class), REQUEST_CODE_ADD_NOTE);
        }
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //  dbRead.execSQL("drop table notes");
        // 查询数据库并将数据显示在ListView上。
        // 这个操作在UI线程，容易引起无响应错误
        adapter = new SimpleCursorAdapter(this, R.layout.notes_list_cell, null, new String[]{NotesDB.COLUMN_NAME_ID, NotesDB.COLUMN_NAME_NOTE_NAME, NotesDB.COLUMN_NAME_NOTE_DATE}, new int[]{R.id.note_id, R.id.tvName, R.id.tvDate});
        ...
        noteList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            /**
             * 笔记列表中的笔记条目被点击时被调用，打开编辑笔记页面，同时传入当前笔记的信息
             * @param parent
             * @param view
             * @param position
             * @param id
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                // 传入笔记id，name，content
                intent.putExtra(AtyEditNote.EXTRA_NOTE_ID, c.getInt(c.getColumnIndex(NotesDB.COLUMN_NAME_ID)));
                intent.putExtra(AtyEditNote.EXTRA_NOTE_NAME, c.getString(c.getColumnIndex(NotesDB.COLUMN_NAME_NOTE_NAME)));
                intent.putExtra(AtyEditNote.EXTRA_NOTE_CONTENT, c.getString(c.getColumnIndex(NotesDB.COLUMN_NAME_NOTE_CONTENT)));
                // 有返回的开启Activity
        ...
        noteList.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                //添加是否确认删除警告框
                Dialog dialog = new AlertDialog.Builder(NotesActivity.this).setTitle("删除信息").setMessage("您确定要删除吗？").setPositiveButton("确定", new DialogInterface.OnClickListener() {
                    /**
                     *确定点击事件响应
                     */
